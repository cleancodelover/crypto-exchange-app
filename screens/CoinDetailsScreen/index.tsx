...
const CoinDetailsScreen = () => {
  const [coinData, setCoinData] = useState({
    ...
    valueChange7D: -1.12,
    currentPrice: 59420,
    priceHistoryString: historyString,
  });
  ...
  return (
    <View style={styles.root}>
      ...
      <CoinPriceGraph dataString={coinData.priceHistoryString} />
